...
async function apiCall(action, method = 'GET', body = null) {
    ...
    const response = await fetch(`admin_api.php?action=${action}`, options);
...
// Tanaman (sama seperti sebelumnya, tidak perlu diubah)
...
// Cuaca (sama seperti sebelumnya, tidak perlu diubah)
...
// User - Perbaikan: pastikan data ditampilkan
...
async function hapusUser(id) {
    if (confirm('Hapus user ini?')) {
        const res = await fetch(`admin_api.php?action=hapus_user`, {
            method: 'POST',
