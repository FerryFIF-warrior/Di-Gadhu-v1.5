...
// ========== EVENT KABUPATEN -> MUAT KECAMATAN ==========
...
// Panggil load provinsi saat halaman siap
loadProvinces();

// ========== FUNGSI ANALISIS (dengan cuaca opsional) ==========
// (Jika Anda memiliki API cuaca, silakan aktifkan; jika tidak, gunakan statis)
async function jalankanAnalisis() {
  ...
  // Contoh: cuaca statis (jika tidak ada API cuaca)
  const cuaca = "hujan"; // ganti dengan logika cuaca jika ada
